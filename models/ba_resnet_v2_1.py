...
class BALayer(nn.Module):
    def __init__(self, in_channels, out_channel, reduction=16):
    ...
    def forward(self, features):
        ...
        fusions = [fusions[i].unsqueeze(-1) for i in range(len(fusions))]
        fusion = self.proj(torch.cat(fusions, dim=2)).squeeze(-1)
...
def ba_resnet18_v2_1(num_classes=1000):
    return ResNet(BasicBlock, [2, 2, 2, 2], num_classes=num_classes)


def ba_resnet34_v2_1(num_classes=1000):
    return ResNet(BasicBlock, [3, 4, 6, 3], num_classes=num_classes)


def ba_resnet50_v2_1(num_classes=1000):
    return ResNet(Bottleneck, [3, 4, 6, 3], num_classes=num_classes)


def ba_resnet101_v2_1(num_classes=1000):
    return ResNet(Bottleneck, [3, 4, 23, 3], num_classes=num_classes)


if __name__ == '__main__':
    model = ba_resnet50_v2_1(num_classes=1000)
