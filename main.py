...
def get_args_parser():
    ...
    parser.add_argument('--epochs', type=int, default=300)  # Depend on the task
    parser.add_argument('--warmup_epochs', type=int, default=20)  # Depend on the task
    parser.add_argument('--weight_decay', type=float, default=0.05)
    parser.add_argument('--base_lr', type=float, default=1e-3)  # Depend on the task
    parser.add_argument('--warmup_lr', type=float, default=1e-6)  # Depend on the task
    parser.add_argument('--min_lr', type=float, default=1e-5)  # Depend on the task
